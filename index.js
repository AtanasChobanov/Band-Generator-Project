...
app.post("/submit", (req, res) => {
  ...
  var randAdjNum = Math.round(Math.random() * (adj.length - 1));
  var randNounNum = Math.round(Math.random() * (noun.length - 1));

  var randomAdj = adj[randAdjNum];
  var randomNoun = noun[randNounNum];
